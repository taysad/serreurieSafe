...
const Sitemap: React.FC = () => {
    const sitemapSections = [
        ...
        },
        {
            ...
            icon: MapPin,
            links: [
                { path: "/serrurier-viry-chatillon", label: "Serrurier Viry-Châtillon (91170)" },
                { path: "/serrurier-juvisy", label: "Serrurier Juvisy-sur-Orge (91260)" },
                { path: "/serrurier-savigny", label: "Serrurier Savigny-sur-Orge (91600)" },
                { path: "/serrurier-ris-orangis", label: "Serrurier Ris-Orangis (91130)" },
                { path: "/serrurier-morsang", label: "Serrurier Morsang-sur-Orge (91390)" },
                { path: "/serrurier-ste-genevieve", label: "Serrurier Sainte Geneviève des Bois (91700)" },
                { path: "/serrurier-draveil", label: "Serrurier Draveil (91210)" },
                { path: "/serrurier-fleury", label: "Serrurier Fleury Mérogis (91700)" },
                { path: "/serrurier-athis-mons", label: "Serrurier Athis-Mons (91200)" },
                { path: "/serrurier-essonne", label: "Serrurier Essonne (91)" },
                { path: "/serrurier-ile-de-france", label: "Serrurier Île-de-France" },
            ],
        },
        {
